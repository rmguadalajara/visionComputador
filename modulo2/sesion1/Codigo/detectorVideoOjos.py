...
cascade_eye = cv2.CascadeClassifier(cascade_eye_fn)
...
out = cv2.VideoWriter('outputOjos.avi', fourcc, fps, (frame_width, frame_height),True)
...
while True:
    ...
    #por cada rect en rects detectar los ojos
    for x1, y1, x2, y2 in rects:
